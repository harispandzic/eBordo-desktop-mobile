...
namespace eBordo.Api.Migrations
{
    ...
    [Migration("20220605103144_db_seed_pozicija")]
    partial class db_seed_pozicija
    {
            ...
            modelBuilder.Entity("eBordo.Api.Database.Pozicija", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            pozicijaId = 2,
                            nazivPozicije = "Štoper",
                            skracenica = "CB"
                        },
                        new
                        {
                            pozicijaId = 3,
                            nazivPozicije = "Lijevi bek",
                            skracenica = "LB"
                        },
                        new
                        {
                            pozicijaId = 4,
                            nazivPozicije = "Desni bek",
                            skracenica = "RB"
                        },
                        new
                        {
                            pozicijaId = 5,
                            nazivPozicije = "Zadnji vezni",
                            skracenica = "CDM"
                        },
                        new
                        {
                            pozicijaId = 6,
                            nazivPozicije = "Centralni vezni",
                            skracenica = "CM"
                        },
                        new
                        {
                            pozicijaId = 7,
                            nazivPozicije = "Prednji vezni",
                            skracenica = "CAM"
                        },
                        new
                        {
                            pozicijaId = 8,
                            nazivPozicije = "Lijevi vezni",
                            skracenica = "LM"
                        },
                        new
                        {
                            pozicijaId = 9,
                            nazivPozicije = "Desni vezni",
                            skracenica = "RM"
                        },
                        new
                        {
                            pozicijaId = 10,
                            nazivPozicije = "Lijevo krilo",
                            skracenica = "LW"
                        },
                        new
                        {
                            pozicijaId = 11,
                            nazivPozicije = "Desno krilo",
                            skracenica = "RW"
                        },
                        new
                        {
                            pozicijaId = 12,
                            nazivPozicije = "Napadač",
                            skracenica = "ST"
                        });
                });
