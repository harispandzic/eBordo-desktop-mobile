...
namespace eBordo.Api.Services.Korisnik
{
    public class KorisnikService: IKorisnikService
    {
        ...
        public KorisnikService(eBordoContext db, IMapper mapper, IHttpContextAccessor httpContext)
        {
            _db = db;
            _mapper = mapper;
        ...
        public Model.Models.Korisnik Auth()
        {
            ...
            var korisnik = _db.korisnici.Where(s => s.korisnickoIme == user).SingleOrDefault();
