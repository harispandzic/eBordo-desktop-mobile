...
namespace eBordo.Api.Services.Korisnik
{
    public class KorisnikService : IKorisnikService
    {
        ...
        public async Task<Model.Models.Korisnik> Login(string username, string password)
        {
            ...
            string tekstPoruke = entity.ime + " " + entity.prezime + ", uspješno ste se prijavili na eBordo platformu. Datum i vrijeme prijave je " + DateTime.Now.ToString();

            //SendEmail(tekstPoruke);
        ...
        public Model.Models.Korisnik Insert(KorisnikInsertRequest request)
        {
            ...
            string tekstPoruke = korisnik.ime + " " + korisnik.prezime + ", dobrodošao na eBordo platformu! Vaš username je " + korisnik.korisnickoIme + ", a vaša lozinka je " + autoGeneratedPassword;
        ...
        private void SendEmail(string tekstPoruke)
        {
            try
            {
                MailMessage mm = new MailMessage("eBordoApp@outlook.com", "eBordoApp@outlook.com");
                ...
                NetworkCredential nc = new NetworkCredential("eBordoApp@outlook.com", "FKSarajevo1946");
