            ...
            children: [
              Container(
                ...
                child: Stack(children: [
                  ...
                  Column(children: [
                    Image.memory(Uint8List.fromList(widget.igrac!.slikaPanel),
                        fit: BoxFit.cover),
                    SizedBox(height: 5),
                    Row(
                    ...
                    children: [
                      ...
                      Row(children: [
                        ...
                        CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            child: ClipOval(
                              child: Image.memory(
                                Uint8List.fromList(widget.igrac!.korisnik
                        ...
                        Text(
                            widget.igrac!.korisnik.gradRodjenja.nazivGrada +
                                ", " +
                                widget.igrac!.korisnik.gradRodjenja.drzava
                                    .nazivDrzave,
                            style: GoogleFonts.oswald(
                              fontSize: 14,
                              color: Colors.black,
                      ...
                      Row(children: [
                        ...
                        Text(
                            DateFormat.yMMMd()
                                .format(DateTime.parse(
                                    widget.igrac!.ugovor.datumPocetka))
                                .toString(),
                            style: GoogleFonts.oswald(
                              fontSize: 14,
                              color: Colors.black,
                      ...
                      Row(children: [
                        ...
                        Text(
                            DateFormat.yMMMd()
                                .format(DateTime.parse(
                                    widget.igrac!.ugovor.datumZavrsetka))
                                .toString(),
                            style: GoogleFonts.oswald(
                              fontSize: 14,
                              color: Colors.black,
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            ...
                            statistika(
                                'assets/zuti.png',
                                widget.igrac!.igracStatistika.zutiKartoni
                                    .toString(),
                                "ŽUTI KARTONI"),
                            SizedBox(width: 30),
                            statistika(
                                'assets/crveni.png',
                                widget.igrac!.igracStatistika.crveniKartoni
                                    .toString(),
                                "CRVENI KARTONI")
                          ],
                        ),
                      ...
                      Row(
                        ...
                        children: widget.data_statistika
                            .map<Widget>(
                                (item) => opisGrafa(item.x, item.color))
                            .toList(),
                      ),
                      SizedBox(
                        height: 10,
                      ...
                      ExpandablePanel(
                        ...
                        expanded: Column(
                          ...
                          children: [
                            ...
                            ocjene(
                                "KONTROLA LOPTE",
                                widget.igrac!.igracSkills.kontrolaLopte
                                    .toDouble()),
                            SizedBox(
                              height: 3,
                            ),
                            ...
                            ocjene("BRZINA",
                                widget.igrac!.igracSkills.brzina.toDouble()),
                            SizedBox(
                              height: 3,
                            ),
                            ocjene("ŠUT",
                                widget.igrac!.igracSkills.sut.toDouble()),
                            SizedBox(
                              height: 3,
                            ),
                            ocjene("SNAGA",
                                widget.igrac!.igracSkills.snaga.toDouble()),
                            SizedBox(
                              height: 3,
                            ),
                            ocjene(
                                "MARKIRANJE",
                                widget.igrac!.igracSkills.markiranje
                                    .toDouble()),
                            SizedBox(
                              height: 3,
                            ),
                            ocjene(
                                "KLIZEĆI START",
                                widget.igrac!.igracSkills.klizeciStart
                                    .toDouble()),
                            SizedBox(
                              height: 3,
                            ),
                            ocjene("SKOK",
                                widget.igrac!.igracSkills.skok.toDouble()),
                            SizedBox(
                              height: 3,
                            ),
                            ocjene("ODBRANA",
                            ...
                            ocjene(
                                "PROSJEČNA OCJENA",
                                widget.igrac!.igracSkills.prosjekOcjena
                                    .toDouble()),
                            SizedBox(
                              height: 10,
                            ),
                            ...
                            Container(
                                child: SfCartesianChart(
                                    ...
                                    series: <
                                        ChartSeries<LineChartData, String>>[
